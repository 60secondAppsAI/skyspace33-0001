...
<template>
  ...
  <base-input label="CheckinTime" type="text" placeholder="Enter CheckinTime" v-model="checkinToAdd.checkinTime"></base-input>
  <base-input label="GateNumber" type="text" placeholder="Enter GateNumber" v-model="checkinToAdd.gateNumber"></base-input>
                  </form>
                </div>
...
export default {
    ...
    return {
      ...
      columns: [
		...
		dataIndex: 'checkinTime',
          ...
          sorter: true
          //sorter: (a, b) => a.checkinTime - b.checkinTime,
  ...
  methods: {
    ...
    async onTableChange(pagination, filters, sorter) {
	  ...
	  this.$emit('get-all-checkins',this.sortBy,this.sortOrder,this.pagination.current-1,this.pagination.pageSize);
