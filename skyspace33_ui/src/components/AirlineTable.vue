...
<template>
  ...
  <base-input label="Headquarters" type="text" placeholder="Enter Headquarters" v-model="airlineToAdd.headquarters"></base-input>
                  </form>
                </div>
    ...
    return {
      ...
      columns: [
		...
		dataIndex: 'headquarters',
          visible: true,
          scopedSlots: { customRender: 'headquarters' },
          sorter: true
          //sorter: (a, b) => a.headquarters - b.headquarters,
