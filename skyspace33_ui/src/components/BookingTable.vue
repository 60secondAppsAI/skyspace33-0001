...
<template>
  ...
  <base-input label="BookingNumber" type="text" placeholder="Enter BookingNumber" v-model="bookingToAdd.bookingNumber"></base-input>
  <base-input label="SeatNumber" type="text" placeholder="Enter SeatNumber" v-model="bookingToAdd.seatNumber"></base-input>
  <base-input label="ClassType" type="text" placeholder="Enter ClassType" v-model="bookingToAdd.classType"></base-input>
    ...
    return {
      ...
      columns: [
		...
		dataIndex: 'bookingNumber',
          visible: true,
          scopedSlots: { customRender: 'bookingNumber' },
          sorter: true
          //sorter: (a, b) => a.bookingNumber - b.bookingNumber,
